...
This post is the beginning of a series about creating Data Driven UX with React.  Over the course of the series, we will iterate over a basic example application until we 
have a generic React component that we can use in any project to easily configure Data Driven UX.
...
In this post we will lay the groundwork that we will expand upon in the rest of the series.
...
For this task, we can lean on the wonderful Create React App CLI tool.  If you do not currently have this tool, it can be acquired by opening your command prompt and entering `npm i -g create-react-app`.  Once you have this tool installed, navigate to a folder you want to use for your tutorials and enter `create-react-app data-driven-ux-part-1` and wait for it to finish setting up your application.
...
We will examine this line and how to better make use of it in a future post, but for now just comment it out.

You should now be able to enter `npm start` at the command prompt to see your React application come to life!

## The App

The purpose of our application is going to be maintaining a list of Notes and/or Reminders so we need some React components to help us do just that.
